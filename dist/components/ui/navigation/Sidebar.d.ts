...
declare const SidebarInput: React.ForwardRefExoticComponent<Omit<import("@/components/ui/form/fields").InputProps & React.RefAttributes<HTMLInputElement>, "ref"> & React.RefAttributes<HTMLInputElement>>;
