...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-7 w-7 toggle-btn hidden", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
      {...props}
    > 
      <svg className="fill-icon-toggle" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M14 1.00003H16V13H14V1.00003ZM0 8.00003H8.586L4.293 12.293L5.707 13.707L12.414 7.00003L5.707 0.29303L4.293 1.70703L8.586 6.00003H0V8.00003Z"/>
      </svg>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      // 🔒 Disabled: sidebar toggle behavior removed
...
>(({ className, ...props }, ref) => (
  <li
    ...
    className={cn("group/menu-item relative pl-[7px]", className)}
    {...props}
  />
))
