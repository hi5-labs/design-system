...
declare const SidebarInput: React.ForwardRefExoticComponent<Omit<import("../form/fields").InputProps & React.RefAttributes<HTMLInputElement>, "ref"> & React.RefAttributes<HTMLInputElement>>;
